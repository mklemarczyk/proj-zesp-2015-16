...
#Region "Navigation"
		...
		''' </summary>
		Public ReadOnly Property DefaultViewModel As Model.ViewModels.Config.ConfigMenuViewModel
			Get
		...
		Public Sub New()
			...
			Me._defaultViewModel = New Model.ViewModels.Config.ConfigMenuViewModel(Me._navigationHelper)
